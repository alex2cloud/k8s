...
curl https://storage.googleapis.com/startup-script-a2c/script/gcp_master_user.sh -o /tmp/gcp_master_user.sh
curl https://storage.googleapis.com/startup-script-a2c/script/cni-cilium_install.sh -o /tmp/cni-cilium_install.sh
sudo chmod +x /tmp/gcp_master_user.sh
sudo chmod +x /tmp/cni-cilium_install.sh
